...
-   The compose file will start the following services:
    ...
    -   `infinity-server` - Used to start local embeddings and rerankers server. `compose.env` has `INFINITY_MODEL_ID` as the environment variable to specify the embedding and reranker.
