...
from backend.modules.query_controllers.examples.opensrc.types import DefaultQueryInput, DEFAULT_QUERY
...
@query_controller('/opensrc')
class OpenSourceQueryController:
    """
    OpenSrc Query Controller
    Used OpenSrc Embeddings and OpenSrc Chat Models
