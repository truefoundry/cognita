...
class TFDocsArtifactLoader(BaseDataLoader):
    """
        ...
        for root, d_names, f_names in os.walk(dest_dir):
            for f in f_names:
                ...
                data_point = DataPoint(
                    ...
                    metadata={
                        # If docs: xyz.md. then rel_path: xyz.md
                        "url" : "https://docs.truefoundry.com/docs/" + rel_path.replace(".md", "")
                    },
                )
                logger.debug("Data point: {}".format(data_point))
